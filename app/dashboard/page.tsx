...
export default function DashboardPage() {
  ...
  const invoices = [
    { name: "Sarah Johnson", email: "sarah@example.com", amount: "$450.00", avatar: "https://i.pravatar.cc/150?img=32" },
    { name: "Michael Brown", email: "michael@example.com", amount: "$220.00", avatar: "https://i.pravatar.cc/150?img=14" },
    { name: "Emily Davis", email: "emily@example.com", amount: "$980.00", avatar: "https://i.pravatar.cc/150?img=25" },
  ];
    ...
    <div className="p-8 space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {summaryCards.map(item => (
          <div key={item.label} className="p-6 rounded-xl border shadow-sm bg-white">
